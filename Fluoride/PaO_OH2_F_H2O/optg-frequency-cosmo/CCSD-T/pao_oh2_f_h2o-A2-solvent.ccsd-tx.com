***, PaO(OH)2(F)(H2O)- MP2 and CCSD(T)
memory,2500, m;
file, 1, pao_oh2_f-A2-solvent.ccsd-tx.int, new;
file, 2, pao_oh2_f-A2-solvent.ccsd-tx.wfu, new;
...
geometry={
include, pao_oh2_f_h2o-A2-solvent.xyz
}
